...
class Header(BaseHeader):
    ...
    def make_insert_list(self, data, file_type: Optional[str]) -> list: ...

    def make_change_list(self, line_data, data, col: int, file_type: Optional[str], rewrite: bool) -> Tuple[
        list, bool]: ...
...
def fix_openpyxl_bug(recorder: Recorder, wb: Workbook, ws: Worksheet, table: Optional[str]) -> tuple: ...
